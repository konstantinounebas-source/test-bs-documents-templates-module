...
export default function IncomeSummaryTab() {
    ...
    // Total Value of Work Performed = Net Earned Income + Total Income Not Earned
    const totalValueOfWorkPerformed = (netEarnedIncome || 0) + (calcValues.totalIncomeNotEarned || 0);
            ...
            <div className="overflow-x-auto">
                <table className="w-full border-collapse text-sm">
                    ...
                    <tbody>
                        ...
                        <tr className="bg-slate-50">
                            <td colSpan={2} className="border border-slate-300 px-3 py-2 font-semibold text-slate-700">Net Earned Income</td>
                            <td className="border border-slate-300 px-3 py-2 text-right"></td>
                        ...
                        <tr className="bg-green-50">
                            ...
                            <td className="border border-slate-300 px-3 py-2 text-right"></td>
                            <td className="border border-slate-300 px-3 py-2 text-right font-bold">{fmt(totalValueOfWorkPerformed)}</td>
                            <td className="border border-slate-300 px-3 py-2 text-xs text-slate-400">= Net Earned Income + Total Income Not Earned</td>
                        </tr>
