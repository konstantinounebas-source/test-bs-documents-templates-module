...
export default function AnnexesTab() {
  ...
  const loadDocuments = async () => {
    try {
      ...
      // Sort revisions by revision_number (descending)
  ...
  return (
    <div className="bg-white rounded-lg border border-slate-200 p-6">
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-lg font-semibold text-slate-900">Annexes Register</h2>
          ...
          <table className="w-full border-collapse text-sm">
            <thead>
              <tr className="bg-slate-100 border-b border-slate-300">
                ...
                <th className="border border-slate-300 px-4 py-2 text-left font-semibold">Revision</th>
