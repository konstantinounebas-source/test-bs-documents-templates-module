...
export default function DailyOperationalCostsSection({
  ...
  const operationalRows = dailyCostsRecords.filter(r => r.date === selectedDate && r.cost_type === 'operational');
  ...
  return (
    <Card>
      <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3">
        <CardTitle className="text-base">Λειτουργικά Κόστη ({operationalRows.length})</CardTitle>
