...
export default function ScheduledDataTab({ selectedDepartment, selectedBundle: initialSelectedBundle, selectedDate: urlSelectedDate }) {
  ...
  return (
    <div className="space-y-4">
      ...
      <AddDialog open={showAddDialog} onClose={setShowAddDialog} formData={formData} setFormData={setFormData} profiles={profiles} itemCodes={itemCodes} qcTypes={qcTypes} qcLevels={qcLevels} onAdd={handleAdd} isAdding={createMutation.isPending} />
      <EditDialog open={showEditDialog} onClose={setShowEditDialog} editingRecord={editingRecord} setEditingRecord={setEditingRecord} onSave={handleUpdateRecord} />
      <DetailsDialog open={showDetailsDialog} onClose={setShowDetailsDialog} selectedRecord={selectedRecord} getRecordDetails={getRecordDetails} />
      <SaveTemplateDialog open={showSaveTemplateDialog} onClose={setShowSaveTemplateDialog} templateName={templateName} setTemplateName={setTemplateName} selectedDate={selectedDate} onSave={handleSaveTemplate} />
      <LoadTemplateDialog open={showLoadTemplateDialog} onClose={setShowLoadTemplateDialog} templates={templates} loadToDate={loadToDate} setLoadToDate={setLoadToDate} onLoad={handleLoadTemplate} isLoading={loadTemplateMutation.isPending} />
      <AssignPersonsDialog open={showAssignPersonsDialog} onClose={setShowAssignPersonsDialog} dayPersons={dayPersons} setDayPersons={setDayPersons} dayNotes={dayNotes} setDayNotes={setDayNotes} persons={persons} currentDayAssignment={currentDayAssignment} onSave={handleSaveDayAssignments} />
