                ...
                <div>
                  ...
                  <ol className="space-y-6">
                    ...
                    <Step 
                       ...
                       description="Κάντε κλικ σε ένα προϊόν για να δείτε τους προμηθευτές. Δείτε αναλυτικό πίνακα με προμηθευτή, κόστος ανά μονάδα, κόστος ανά item, και raw qty. Ορίστε τον 'Preferred' vendor. Μπορείτε να προσθέσετε νέους προμηθευτές και να επεξεργαστείτε τις τιμές inline ή μέσω των κινήσεων αποθήκης." 
                     />
